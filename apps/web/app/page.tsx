    ...
    if (savedToken) {
      ...
      (async () => {
        try {
          ...
          // Token is invalid (e.g., server restarted) - clear it and show auth
    ...
    <main className="od-shell">
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .auth-logo {
          font-size: 48px;
          filter: drop-shadow(0 0 20px rgba(200, 160, 70, 0.4));
        }
        .auth-title {
        ...
        .list-item--selected {
          border-color: var(--gold);
          background: rgba(140, 95, 30, 0.12);
        }
