...
const SYSTEM_PROMPT = [
  ...
  "The module body is clear instructions to the DM — what stateOps/varId updates to emit,",
  ...
  "  - <What stateOps on which varId to emit and when>",
  ...
  "  - reference specific varId values the DM should update",
